<template>
  <div class="page21-container">
    <div class="page21-frame40">
      <div class="page21-group39">
        <div class="page21-container1">
          <div class="page21-container2">
...
export default {
  name: 'Page21',
  metaInfo: {
    title: 'Page21 - exported project',
    meta: [
      {
        property: 'og:title',
        content: 'Page21 - exported project',
      },
    ],
  },
}
