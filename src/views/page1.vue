<template>
  <div class="page1-container">
    <div class="page1-container1">
      <img
        alt="image"
        src="/playground_assets/image155-8q0i-400w.png"
        class="page1-image"
      />
      <img
        alt="image"
        src="/playground_assets/image2610-ek8g-400w.png"
        class="page1-image1"
      />
      <span class="page1-text">Математика с Олафом</span>
      <router-link to="/1" class="page1-navlink button">Начать</router-link>
    </div>
  </div>
</template>
...
.page1-navlink {
  ...
  text-decoration: none;
  background-image: url("/playground_assets/rectangle31427-27o-500w.png");
