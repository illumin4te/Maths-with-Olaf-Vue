<template>
  <div class="page6-container">
    <div class="page6-frame7">
      <div class="page6-group6">
        <img
          alt="Rectangle41536"
          ...
          class="page6-rectangle4"
        />
        <div class="page6-group5"><span class="page6-text">1</span></div>
        <img
          alt="IMAGE112215"
      ...
      <div class="page6-group4">
        <router-link to="/1" class="page6-navlink">
          <img
            alt="home1541"
...
export default {
  name: 'Page6',
  metaInfo: {
    title: 'Page6 - exported project',
    meta: [
      {
        property: 'og:title',
        content: 'Page6 - exported project',
      },
    ],
  },
}
